...
export default class ShowCompany extends Component {
  ...
  onDeleteUser = async (user, e) => {
    ...
    try {
      await axios.delete(`http://localhost:5000/api/v1/ngo/${user}`, config);
          ...
          <div id="portfolio">
            <div className="container showtop  login-second ">
              <div className="page-title text-center">
                <h1 className="text-dark">Ngo's</h1>
                      ...
                      <table className="table table-hover">
                        ...
                        {this.state.ngo.map((ngo) => (
                          <tr>
                            <td className="tbld">
                              <img
                                src={`data:image/png;base64,${ngo.photo}`}
                                alt=""
                                width="150px"
                                height="100px"
                              ></img>
                            </td>
                            <td className="tbld text-dark">{ngo.name}</td>
                            <td className="tbld text-dark">{ngo.address}</td>
                            <td className="tbld text-dark">{ngo.email}</td>
                            ...
                            <td className="d-flex justify-content-center tbld">
                              <div className="btn-group ">
                                <a
                                  ...
                                  value={ngo._id}
                                  onClick={(e) => this.onDeleteUser(ngo._id, e)}
                                >
